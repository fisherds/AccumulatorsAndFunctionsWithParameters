...
def test_digits_in_cube():
    ...
    # Test 1:
    expected = 9
    answer = digits_in_cube(3)  # via 27
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 2:
    expected = 36
    answer = digits_in_cube(123)  # via 1860867
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
...
def test_digits_in_power():
    ...
    # Test 1:
    expected = 5
    answer = digits_in_power(2, 5)  # via 32
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 2:
    expected = 36
    answer = digits_in_power(123, 3)  # via 1860867
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = digits_in_power(101, 1)  # via 1860867
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def test_fancy_sums_of_digits():
    ...
    # Test 1:
    expected = 1
    answer = fancy_sums_of_digits(10)  # via sum_of_digits(1 * 1)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 2:
    expected = 19084
    answer = fancy_sums_of_digits(2)  # via sum_of_digits(1 * 1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 124309
    answer = fancy_sums_of_digits(35)  # via sum_of_digits(1 * 1)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def fancy_sums_of_digits(n):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    return sum_of_digits(digits_in_power(n, 1000) ** digits_in_power(n, 999))
